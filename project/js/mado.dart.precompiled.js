...
InputElement: {"": "HtmlElement;name=-,value%-",
...
ProgressEvent: {"": "Event;", "%": "XMLHttpRequestProgressEvent;ProgressEvent"},
...
["help_array", "help/array.dart", , U, {
HelpArray: {"": "Object;words-,answers-,examples-"}}],
["help_block", "help/block.dart", , L, {
HelpBlock: {"": "Object;answer-,example-,result-,resultSwitch-",
  changeAnswer$4: function(word, wordPos, inputLength, newAnswer) {
    var t1, t2, t3;
    t1 = this.answer;
    t2 = "<span class=\"help-title\">" + J.getInterceptor$s(word).substring$2(word, 0, wordPos) + "<span class=\"match\">";
    if (typeof wordPos !== "number")
      throw wordPos.$add();
    t3 = wordPos + inputLength;
    J.setInnerHtml$1$x(t1, t2 + C.JSString_methods.substring$2(word, wordPos, t3) + "</span>" + C.JSString_methods.substring$1(word, t3) + "</span>: " + newAnswer);
  },
  switchResult$0: function() {
    var t1 = this.result;
    if (t1.className === "result")
      t1.className = "result switched";
    else
      t1.className = "result";
  },
  HelpBlock$1: function(number) {
    var t1, t2;
    t1 = "#answer-" + C.JSInt_methods.toString$0(number);
    this.answer = document.querySelector(t1);
    t1 = "#example-" + C.JSInt_methods.toString$0(number);
    this.example = document.querySelector(t1);
    t1 = "#result-" + C.JSInt_methods.toString$0(number);
    this.result = document.querySelector(t1);
    t1 = "#result-switch-" + C.JSInt_methods.toString$0(number);
    this.resultSwitch = document.querySelector(t1);
    t1 = this.resultSwitch;
    t1.toString;
    t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.HelpBlock_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  static: {
HelpBlock$: function(number) {
  var t1 = new L.HelpBlock(null, null, null, null);
  t1.HelpBlock$1(number);
  return t1;
}}

},

HelpBlock_closure: {"": "Closure;this_0-",
  call$1: function(e) {
    this.this_0.switchResult$0();
  },
  $is_args1: true
}}],
["help_manager", "help/manager.dart", , A, {
HelpManager: {"": "Object;helpButton-,helpDisplayer-,helpInput-,resultsContainer-,helpBlock-,maxAnswers-,wordPos-,helpArray-",
  answer$0: function() {
    var t1, t2, t3, t4, t5, t6, i, t7, j, t8, t9, t10, t11;
    this.maxAnswers = 1;
    t1 = this.helpArray;
    t2 = t1.words;
    t3 = this.helpInput;
    ...
    while (true) {
      ...
      if (i >= 16)
        throw H.ioore(t2, i);
      j = 0;
      for (; t7 = t2[i], t8 = t7.length, j < t8; ++j) {
        if (j < 0)
          throw H.ioore(t7, j);
        if (C.JSString_methods.indexOf$1(J.toLowerCase$0$s(t7[j]), J.toLowerCase$0$s(t4.get$value(t3))) !== -1) {
          t7 = t2[i];
          if (j >= t7.length)
            throw H.ioore(t7, j);
          this.wordPos = C.JSString_methods.indexOf$1(J.toLowerCase$0$s(t7[j]), J.toLowerCase$0$s(t4.get$value(t3)));
          t7 = this.maxAnswers;
          if (typeof t7 !== "number")
            throw t7.$sub();
          --t7;
          ...
          if (j >= t8.length)
            throw H.ioore(t8, j);
          t8 = J.toString$0(t8[j]);
          t9 = this.wordPos;
          t10 = J.get$length$asx(t4.get$value(t3));
          t11 = H.IterableMixinWorkaround_toStringIterable(t6[i], "[", "]");
          t7.changeAnswer$4(t8, t9, t10, C.JSString_methods.substring$2(t11, 1, t11.length - 1));
          t11 = this.maxAnswers;
          if (typeof t11 !== "number")
            throw t11.$sub();
          --t11;
          if (t11 < 0 || t11 >= 3)
            throw H.ioore(t5, t11);
          t11 = t5[t11].example;
          t10 = H.IterableMixinWorkaround_toStringIterable(t1[i], "[", "]");
          J.setInnerHtml$1$x(t11, C.JSString_methods.substring$2(t10, 1, t10.length - 1));
          t10 = this.maxAnswers;
          if (typeof t10 !== "number")
            throw t10.$add();
          this.maxAnswers = t10 + 1;
          j = t2[i].length;
        }
      }
      ++i;
    }
    switch (this.maxAnswers) {
      case 1:
        J.setInnerHtml$1$x(t5[0].answer, "No help found.");
        this.resultsContainer.className = "one-result no-result";
        this.resetAnswerDiv$1(2);
        break;
      case 2:
        this.resultsContainer.className = "one-result";
        this.resetAnswerDiv$1(2);
        break;
      case 3:
        this.resultsContainer.className = "two-results";
        this.resetAnswerDiv$1(3);
        break;
      case 4:
        this.resultsContainer.className = "three-results";
        break;
      default:
    }
  },
...
HelpManager_closure: {"": "Closure;this_0-",
  call$1: function(e) {
    this.this_0.displayAnswers$0();
  },
  $is_args1: true
}}],
["images_help", "md_to_html/images_help.dart", , X, {
ImagesHelp: {"": "Object;altInput-,galleriesButton-,imageButton-,imageBox-,imageBrowser-,imageDisplayer-,imageStatus-,titleInput-,imgManager-",
  show$0: function(_) {
    J.setInnerHtml$1$x(this.imageBrowser, "Choose an image");
    J.set$display$x(this.imageStatus.style, "none");
    J.set$value$x(this.altInput, "");
    J.set$value$x(this.titleInput, "");
    this.imageDisplayer.className = "tool-displayer";
  },
  ImagesHelp$1: function(imagesManager) {
    var t1, t2;
    this.imgManager = imagesManager;
    t1 = this.galleriesButton;
    t1.toString;
    t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.ImagesHelp_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  static: {
ImagesHelp$: function(imagesManager) {
  var t1 = new X.ImagesHelp(document.querySelector("#alt-input"), document.querySelector("#galleries-button"), document.querySelector("#image-button"), document.querySelector("#image-insertion-box"), document.querySelector("#browse-image"), document.querySelector("#image-insertion-displayer"), document.querySelector("#image-status"), document.querySelector("#title-input"), null);
  t1.ImagesHelp$1(imagesManager);
  return t1;
}}

},

ImagesHelp_closure: {"": "Closure;this_0-",
  call$1: function(e) {
    P.print("It's working but chrome is really hard to manage.");
  },
  $is_args1: true
}}],
["images_manager", "md_to_html/images_manager.dart", , F, {
ImagesManager: {"": "Object;currentGallery-,galleriesList-,image-,imageLoaded-,imagePath-,imagePosition-,imagesArray-,imgHelp-,imgFormats-,rightFile-,translator-",
  displayImages$0: function() {
    var t1, t2, t3, i, t4;
    t1 = J.indexOf$2$asx(this.translator.tempConversion, "<img src=\"", this.imagePosition);
    t2 = this.translator;
    if (t1 !== -1) {
      this.imagePosition = J.indexOf$2$asx(t2.tempConversion, "<img src=\"", this.imagePosition) + 10;
      this.rightFile = false;
      t1 = this.translator.tempConversion;
      t2 = this.imagePosition;
      t3 = J.getInterceptor$asx(t1);
      this.imagePath = t3.substring$2(t1, t2, t3.indexOf$2(t1, "\"", t2));
      if (J.substring$2$s(this.imagePath, 0, 4) !== "data")
        if (this.imagesArray.length > 0) {
          for (i = 0; t1 = this.imagesArray, i < t1.length; ++i)
            if (J.$eq(J.$index$asx(t1[i], 0), this.imagePath)) {
              t1 = this.translator;
              t2 = t1.tempConversion;
              t3 = this.imagePath;
              t4 = this.imagesArray;
              if (i >= t4.length)
                throw H.ioore(t4, i);
              t1.tempConversion = J.replaceAll$2$s(t2, t3, J.$index$asx(t4[i], 1));
              t4 = this.imagesArray;
              if (i >= t4.length)
                throw H.ioore(t4, i);
              J.$indexSet$ax(t4[i], 2, true);
              if (J.indexOf$2$asx(this.translator.tempConversion, "<img src=\"", this.imagePosition) !== -1) {
                this.displayImages$0();
                break;
              } else
                this.translator.endOfConversion$0();
            } else if (i === this.imagesArray.length - 1)
              H.printToConsole("a");
        } else
          H.printToConsole("a");
      else
...
main: function() {
  var t1, t2;
  $.help = A.HelpManager$();
  $.htmlTranslator = A.Translator$();
  $.htmlTranslator.conversion$0();
  t1 = new W._EventStream(document, C.EventStreamProvider_click._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(V.clickManagement$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = new W._EventStream(window, C.EventStreamProvider_keydown._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(V.shortcutsManagement$closure), t2._useCapture);
...
clickManagement: function($event) {
  ...
  if (V.isInDiv(t1.get$target($event), $.help.helpButton.id) && $.help.helpDisplayer.className === "tool-displayer hidden") {
    t1 = $.help;
    t1.helpDisplayer.className = "tool-displayer";
    t1.helpInput.focus();
  } else if (!V.isInDiv(t1.get$target($event), $.help.helpDisplayer.id) && $.help.helpDisplayer.className !== "tool-displayer hidden")
    $.help.hide$0();
  else if (V.isInDiv(t1.get$target($event), $.htmlTranslator.imageManager.imgHelp.imageButton.id) && $.htmlTranslator.imageManager.imgHelp.imageDisplayer.className === "tool-displayer hidden") {
    t1 = $.htmlTranslator.imageManager.imgHelp;
    t1.show$0(t1);
  } else if (!V.isInDiv(t1.get$target($event), $.htmlTranslator.imageManager.imgHelp.imageDisplayer.id) && $.htmlTranslator.imageManager.imgHelp.imageDisplayer.className !== "tool-displayer hidden")
    $.htmlTranslator.imageManager.imgHelp.imageDisplayer.className = "tool-displayer hidden";
},

shortcutsManagement: function($event) {
  var t1 = J.getInterceptor$x($event);
  if (t1.get$ctrlKey($event) === true) {
    if (t1.get$keyCode($event) === 72) {
      t1 = $.help;
      t1.helpDisplayer.className = "tool-displayer";
      t1.helpInput.focus();
    }
...
isInDiv: function(element, div) {
  var t1, t2;
  if (element != null) {
    t1 = J.getInterceptor$x(element);
    t2 = t1.get$id(element);
    if (t2 == null ? div == null : t2 === div)
      return true;
    else
      return V.isInDiv(t1.get$parent(element), div);
  } else
    return false;
}},
1],
["markdown", "packages/markdown/markdown.dart", , F, {
markdownToHtml: function(markdown, inlineSyntaxes, linkResolver) {
  var t1, $document, lines;
  t1 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
  H.setRuntimeTypeInfo(t1, [J.JSString, F.Link]);
  $document = new F.Document(t1, inlineSyntaxes, linkResolver);
  lines = J.split$1$s(J.replaceAll$2$s(markdown, "\r\n", "\n"), "\n");
  $document.parseRefLinks$1(lines);
  return new F.HtmlRenderer(null).render$1($document.parseLines$1(lines));
},

BlockSyntax_syntaxes: function() {
  if ($.BlockSyntax__syntaxes == null)
    $.BlockSyntax__syntaxes = [new F.EmptyBlockSyntax(), new F.BlockHtmlSyntax(), new F.SetextHeaderSyntax(), new F.HeaderSyntax(), new F.CodeBlockSyntax(), new F.GitHubCodeBlockSyntax(), new F.BlockquoteSyntax(), new F.HorizontalRuleSyntax(), new F.UnorderedListSyntax(), new F.OrderedListSyntax(), new F.ParagraphSyntax()];
...
BlockSyntax_isAtBlockEnd: function(parser) {
  ...
  if (parser.pos >= parser.lines.length)
    return true;
  t1 = F.BlockSyntax_syntaxes();
  t1.toString;
  return H.IterableMixinWorkaround_any(t1, new F.BlockSyntax_isAtBlockEnd_closure(parser));
},

Document: {"": "Object;refLinks-,inlineSyntaxes-,linkResolver-",
  parseRefLinks$1: function(lines) {
    var pattern, t1, i, match, t2, t3, id, url, title;
    pattern = new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("^[ ]{0,3}\\[([^\\]]+)\\]:\\s+(\\S+)\\s*(\"[^\"]+\"|'[^']+'|\\([^)]+\\)|)\\s*$", false, true, false), null, null);
    for (t1 = this.refLinks, i = 0; i < lines.length; ++i) {
      ...
      if (match != null) {
        ...
        if (t2.$eq(title, ""))
          ...
          if (typeof t3 !== "number")
            throw t3.$sub();
          title = t2.substring$2(title, 1, t3 - 1);
        }
        id = J.toLowerCase$0$s(id);
        t1.$indexSet(t1, id, new F.Link(id, url, title));
        if (i >= lines.length)
  ...
  parseLines$1: function(lines) {
    ...
    parser = new F.BlockParser(lines, this, 0);
    blocks = [];
    for (t1 = parser.lines; parser.pos < t1.length;)
      for (t2 = F.BlockSyntax_syntaxes(), t2.length, t2 = new H.ListIterator(t2, 11, 0, null); t2.moveNext$0();) {
        syntax = t2._current;
  ...
  accept$1: function(_, visitor) {
    ...
    if (visitor.visitElementBefore$1(this)) {
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        J.accept$1$x(t1._current, visitor);
      visitor.buffer.write$1("</" + this.tag + ">");
    }
  }
},
...
Text: {"": "Object;text>-",
  accept$1: function(_, visitor) {
    visitor.buffer.write$1(this.text);
    return;
  },
  $isText: true
},
...
BlockSyntax: {"": "Object;",
  ...
  parseChildLines$1: function(parser) {
    ...
    childLines = [];
    H.setRuntimeTypeInfo(childLines, [J.JSString]);
    for (t1 = parser.lines; t2 = parser.pos, t3 = t1.length, t2 < t3;) {
      t4 = this.get$pattern(this);
      if (t2 < 0 || t2 >= t3)
        throw H.ioore(t1, t2);
...
BlockSyntax_isAtBlockEnd_closure: {"": "Closure;parser_0-",
  call$1: function(s) {
    return s.canParse$1(this.parser_0) && s.get$canEndBlock();
  },
  $is_args1: true
},
...
SetextHeaderSyntax: {"": "BlockSyntax;",
  ...
  parse$1: function(parser) {
    ...
    if (t2 < 0 || t2 >= t1.length)
      throw H.ioore(t1, t2);
    contents = F.InlineParser$(t1[t2], parser.document).parse$0();
    parser.pos = parser.pos + 1;
    parser.pos = parser.pos + 1;
    t2 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t2, [J.JSString, J.JSString]);
    return new F.Element0(tag, contents, t2);
  }
},
...
HeaderSyntax: {"": "BlockSyntax;",
  ...
  parse$1: function(parser) {
    ...
    if (2 >= t3.length)
      throw H.ioore(t3, 2);
    contents = F.InlineParser$(J.trim$0$s(t3[2]), parser.document).parse$0();
    t3 = "h" + H.S(level);
    t2 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t2, [J.JSString, J.JSString]);
    return new F.Element0(t3, contents, t2);
  }
},
...
BlockquoteSyntax: {"": "BlockSyntax;",
  ...
  parse$1: function(parser) {
    var children, t1;
    children = parser.document.parseLines$1(this.parseChildLines$1(parser));
    t1 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t1, [J.JSString, J.JSString]);
    return new F.Element0("blockquote", children, t1);
  }
},
...
CodeBlockSyntax: {"": "BlockSyntax;",
  ...
  parseChildLines$1: function(parser) {
    ...
    for (t1 = parser.lines; parser.pos < t1.length;) {
      ...
      if (match != null) {
        ...
        nextMatch = parser.get$next() != null ? $.get$_RE_INDENT().firstMatch$1(parser.get$next()) : null;
        t2 = parser.pos;
        if (t2 < 0 || t2 >= t1.length)
          throw H.ioore(t1, t2);
  ...
  parse$1: function(parser) {
    var childLines, escaped, t1, t2;
    childLines = this.parseChildLines$1(parser);
    childLines.push("");
    escaped = J.replaceAll$2$s(J.replaceAll$2$s(C.JSString_methods.replaceAll$2(C.JSArray_methods.join$1(childLines, "\n"), "&", "&amp;"), "<", "&lt;"), ">", "&gt;");
    t1 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t1, [J.JSString, J.JSString]);
    t2 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t2, [J.JSString, J.JSString]);
    return new F.Element0("pre", [new F.Element0("code", [new F.Text(escaped)], t1)], t2);
  }
},
...
GitHubCodeBlockSyntax: {"": "BlockSyntax;",
  ...
  parse$1: function(parser) {
    var t1, t2, t3, childLines, escaped;
    t1 = $.get$_RE_CODE();
    t2 = parser.lines;
    t3 = parser.pos;
    if (t3 < 0 || t3 >= t2.length)
    ...
    H.setRuntimeTypeInfo(t3, [J.JSString, J.JSString]);
    t2 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t2, [J.JSString, J.JSString]);
    return new F.Element0("pre", [new F.Element0("code", [new F.Text(escaped)], t3)], t2);
  }
},
...
HorizontalRuleSyntax: {"": "BlockSyntax;",
  ...
  parse$1: function(parser) {
    ...
    if (t3 < 0 || t3 >= t2.length)
      throw H.ioore(t2, t3);
    t1.firstMatch$1(t2[t3]);
    parser.pos = parser.pos + 1;
    t3 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t3, [J.JSString, J.JSString]);
    return new F.Element0("hr", null, t3);
  }
},
...
BlockHtmlSyntax: {"": "BlockSyntax;",
  ...
  parse$1: function(parser) {
    ...
    t1 = parser.lines;
    while (true) {
      if (!(parser.pos < t1.length && !parser.matches$1(parser, $.get$_RE_EMPTY())))
        break;
      t2 = parser.pos;
      if (t2 < 0 || t2 >= t1.length)
        throw H.ioore(t1, t2);
    ...
    return new F.Text(C.JSArray_methods.join$1(childLines, "\n"));
  }
},
...
ListSyntax: {"": "BlockSyntax;",
  ...
  parse$1: function(parser) {
    var t1, items, childLines, t2, t3, t4, t5, t6, i, j, i0, itemNodes, item, blockItem, t7, t8, pattern, children, contents;
    t1 = {};
    items = [];
    H.setRuntimeTypeInfo(items, [F.ListItem]);
    childLines = [];
    H.setRuntimeTypeInfo(childLines, [J.JSString]);
    t1.childLines_0 = childLines;
    t2 = new F.ListSyntax_parse_endItem(t1, items);
    t1.match_1 = null;
    t3 = new F.ListSyntax_parse_tryMatch(t1, parser);
    for (t4 = parser.lines; parser.pos < t4.length;) {
      if (t3.call$1($.get$_RE_EMPTY()) === true)
        t1.childLines_0.push("");
      else if (t3.call$1($.get$_RE_UL()) === true || t3.call$1($.get$_RE_OL()) === true) {
        t2.call$0();
        t5 = t1.childLines_0;
        t6 = t1.match_1._match;
        if (1 >= t6.length)
          throw H.ioore(t6, 1);
        t5.push(t6[1]);
        ...
        if (1 >= t6.length)
          throw H.ioore(t6, 1);
        t5.push(t6[1]);
      } else if (F.BlockSyntax_isAtBlockEnd(parser))
        break;
      else {
        t5 = t1.childLines_0;
    ...
    itemNodes = [];
    H.setRuntimeTypeInfo(itemNodes, [F.Node0]);
    for (t1 = new H.ListIterator(items, items.length, 0, null), t2 = parser.document; t1.moveNext$0();) {
      item = t1._current;
      blockItem = item.get$forceBlock() || item.lines.length > 1;
      t3 = $.get$_RE_BLOCKQUOTE();
      t4 = $.get$_RE_HEADER();
      t5 = $.get$_RE_HR();
      t6 = $.get$_RE_INDENT();
      t7 = $.get$_RE_UL();
      t8 = $.get$_RE_OL();
      if (!blockItem)
        for (t3 = new H.ListIterator([t3, t4, t5, t6, t7, t8], 6, 0, null), t4 = item.lines; blockItem = false, t3.moveNext$0();) {
          pattern = t3._current;
          if (0 >= t4.length)
            throw H.ioore(t4, 0);
          if (pattern.firstMatch$1(t4[0]) != null) {
            blockItem = true;
            break;
          }
        }
      ...
      if (blockItem) {
        ...
        t3 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        t3.$builtinTypeInfo = [J.JSString, J.JSString];
        itemNodes.push(new F.Element0("li", children, t3));
      } else {
        if (0 >= t3.length)
          throw H.ioore(t3, 0);
        contents = F.InlineParser$(t3[0], t2).parse$0();
        t3 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        t3.$builtinTypeInfo = [J.JSString, J.JSString];
        itemNodes.push(new F.Element0("li", contents, t3));
      }
    }
    t1 = this.get$listTag();
    t2 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t2, [J.JSString, J.JSString]);
    return new F.Element0(t1, itemNodes, t2);
  }
},

ListSyntax_parse_endItem: {"": "Closure;box_0-,items_1-",
  call$0: function() {
    var t1, t2, childLines;
    t1 = this.box_0;
    t2 = t1.childLines_0;
    if (t2.length > 0) {
      this.items_1.push(new F.ListItem(false, t2));
      childLines = [];
      H.setRuntimeTypeInfo(childLines, [J.JSString]);
      t1.childLines_0 = childLines;
    }
...
ListSyntax_parse_tryMatch: {"": "Closure;box_0-,parser_2-",
  call$1: function(pattern) {
    ...
    if (t1 < 0 || t1 >= t2.length)
      throw H.ioore(t2, t1);
    t3 = this.box_0;
    t3.match_1 = pattern.firstMatch$1(t2[t1]);
    return t3.match_1 != null;
  },
  $is_args1: true
},
...
ParagraphSyntax: {"": "BlockSyntax;",
  ...
  parse$1: function(parser) {
    ...
    childLines = [];
    for (t1 = parser.lines; !F.BlockSyntax_isAtBlockEnd(parser);) {
      t2 = parser.pos;
      if (t2 < 0 || t2 >= t1.length)
        throw H.ioore(t1, t2);
      childLines.push(t1[t2]);
    ...
    contents = F.InlineParser$(C.JSArray_methods.join$1(childLines, "\n"), parser.document).parse$0();
    t1 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t1, [J.JSString, J.JSString]);
    return new F.Element0("p", contents, t1);
  }
},
...
HtmlRenderer: {"": "Object;buffer-",
  render$1: function(nodes) {
    ...
    for (t1 = new H.ListIterator(nodes, nodes.length, 0, null); t1.moveNext$0();)
      J.accept$1$x(t1._current, this);
    return J.toString$0(this.buffer);
  },
  visitElementBefore$1: function(element) {
    var t1, t2, attributeNames, $name, t3, t4;
    if (this.buffer._contents.length !== 0 && $.get$HtmlRenderer__BLOCK_TAGS().firstMatch$1(element.tag) != null)
      this.buffer.write$1("\n");
    this.buffer.write$1("<" + element.tag);
    t1 = element.attributes;
    t2 = t1.get$keys();
    attributeNames = P.List_List$from(t2, true, H.getRuntimeTypeArgument(t2, "IterableBase", 0));
    H.IterableMixinWorkaround_sortList(attributeNames, new F.HtmlRenderer_visitElementBefore_closure());
    for (t2 = new H.ListIterator(attributeNames, attributeNames.length, 0, null); t2.moveNext$0();) {
      $name = t2._current;
      t3 = this.buffer;
      t4 = " " + H.S($name) + "=\"" + H.S(t1.$index(t1, $name)) + "\"";
      t3.toString;
  ...
  static: {
"": "HtmlRenderer__BLOCK_TAGS-",
}

},

HtmlRenderer_visitElementBefore_closure: {"": "Closure;",
  call$2: function(a, b) {
    return J.compareTo$1$ns(a, b);
  },
  $is_args2: true
...
InlineParser: {"": "Object;source-,document-,syntaxes-,pos-,start-,_stack-",
  parse$0: function() {
    var t1, t2, t3, i, matched, t4;
    t1 = this._stack;
    t2 = [];
    H.setRuntimeTypeInfo(t2, [F.Node0]);
    t1.push(new F.TagState(0, 0, null, t2));
    for (t2 = this.source, t3 = J.getInterceptor$asx(t2); this.pos !== t3.get$length(t2);) {
      ...
      if (matched)
        continue;
      for (t4 = this.syntaxes, t4 = new H.ListIterator(t4, t4.length, 0, null); matched = false, t4.moveNext$0();)
        if (t4._current.tryMatch$1(this)) {
          matched = true;
          break;
        }
      if (matched)
    ...
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    t1 = t1[0];
    return t1.close$2(t1, this, null);
  },
  writeTextRange$2: function(start, end) {
    ...
    if (end > start) {
      ...
      if (nodes.length > 0) {
        ...
        t2 = J.getInterceptor(t1);
        t2 = typeof t1 === "object" && t1 !== null && !!t2.$isText;
        t1 = t2;
      } else
        t1 = false;
      if (t1) {
        ...
        t3 = t2 - 1;
        if (t3 < 0)
          throw H.ioore(nodes, t3);
        nodes[t3] = new F.Text(t1);
      } else
        nodes.push(new F.Text(text));
    }
  },
  InlineParser$2: function(source, $document) {
    var t1, t2, t3;
    this.syntaxes = $.get$InlineParser_defaultSyntaxes();
    t1 = this.syntaxes;
    t2 = F.LinkSyntax_linkPattern();
    t3 = H.JSSyntaxRegExp_makeNative("\\[", true, true, false);
    C.JSArray_methods.insert$2(t1, 1, new F.LinkSyntax(this.document.linkResolver, new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative(t2, true, true, false), null, null), null, new H.JSSyntaxRegExp(t3, null, null)));
  },
  static: {
"": "InlineParser_defaultSyntaxes-",
InlineParser$: function(source, $document) {
  var t1 = [];
  H.setRuntimeTypeInfo(t1, [F.TagState]);
  t1 = new F.InlineParser(source, $document, null, 0, 0, t1);
...
TextSyntax: {"": "InlineSyntax;substitute-,pattern-",
  onMatch$2: function(parser, match) {
    ...
    C.JSArray_methods.get$last(parser._stack).children.push(new F.Text(t1));
    return true;
  }
},
...
AutolinkSyntax: {"": "InlineSyntax;pattern-",
  onMatch$2: function(parser, match) {
    var t1, url, t2, anchor;
    t1 = match._match;
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    url = t1[1];
    t1 = J.replaceAll$2$s(J.replaceAll$2$s(J.replaceAll$2$s(url, "&", "&amp;"), "<", "&lt;"), ">", "&gt;");
    t2 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t2, [J.JSString, J.JSString]);
    anchor = new F.Element0("a", [new F.Text(t1)], t2);
    t2 = anchor.attributes;
    t2.$indexSet(t2, "href", url);
    C.JSArray_methods.get$last(parser._stack).children.push(anchor);
    return true;
  }
},
...
TagSyntax: {"": "InlineSyntax;endPattern-,tag-,pattern-",
  onMatch$2: function(parser, match) {
    ...
    if (typeof t2 !== "number")
      throw H.iae(t2);
    t3 = [];
    H.setRuntimeTypeInfo(t3, [F.Node0]);
    parser._stack.push(new F.TagState(t1, t1 + t2, this, t3));
    return true;
  },
  onMatchEnd$3: function(parser, match, state) {
    var t1 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t1, [J.JSString, J.JSString]);
    C.JSArray_methods.get$last(parser._stack).children.push(new F.Element0(this.tag, state.children, t1));
    return true;
  },
  static: {
TagSyntax$: function(pattern, end, tag) {
  var t1 = H.JSSyntaxRegExp_makeNative(pattern, true, true, false);
  return new F.TagSyntax(new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative(end != null ? end : pattern, true, true, false), null, null), tag, new H.JSSyntaxRegExp(t1, null, null));
}}

},

LinkSyntax: {"": "TagSyntax;linkResolver-,endPattern-,tag-,pattern-",
  onMatchEnd$3: function(parser, match, state) {
    var t1, t2, t3, url, title, id, link, anchor;
    t1 = match._match;
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    t2 = t1[1];
    ...
    if (t2) {
      ...
      if (4 >= t3)
        throw H.ioore(t1, 4);
      title = t1[4];
      if (J.getInterceptor$s(url).startsWith$1(url, "<") && C.JSString_methods.endsWith$1(url, ">"))
        url = C.JSString_methods.substring$2(url, 1, url.length - 1);
    } else {
      if (2 >= t3)
        throw H.ioore(t1, 2);
      id = t1[2];
      t1 = parser.document.refLinks;
      link = t1.$index(t1, J.toLowerCase$0$s(J.$eq(id, "") ? J.substring$2$s(parser.source, state.startPos + 1, parser.pos) : id));
      if (link == null)
        return false;
      t1 = J.getInterceptor$x(link);
      url = t1.get$url(link);
      title = t1.get$title(link);
    }
    t1 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t1, [J.JSString, J.JSString]);
    anchor = new F.Element0("a", state.children, t1);
    t1 = anchor.attributes;
    t1.$indexSet(t1, "href", J.replaceAll$2$s(J.replaceAll$2$s(J.replaceAll$2$s(url, "&", "&amp;"), "<", "&lt;"), ">", "&gt;"));
    if (title != null && !J.$eq(title, ""))
      t1.$indexSet(t1, "title", J.replaceAll$2$s(J.replaceAll$2$s(J.replaceAll$2$s(title, "&", "&amp;"), "<", "&lt;"), ">", "&gt;"));
    C.JSArray_methods.get$last(parser._stack).children.push(anchor);
    return true;
  },
  static: {
...
CodeSyntax: {"": "InlineSyntax;pattern-",
  onMatch$2: function(parser, match) {
    ...
    if (1 >= t1.length)
      throw H.ioore(t1, 1);
    t1 = J.replaceAll$2$s(J.replaceAll$2$s(J.replaceAll$2$s(t1[1], "&", "&amp;"), "<", "&lt;"), ">", "&gt;");
    t2 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    H.setRuntimeTypeInfo(t2, [J.JSString, J.JSString]);
    C.JSArray_methods.get$last(parser._stack).children.push(new F.Element0("code", [new F.Text(t1)], t2));
    return true;
  }
},
...
TagState: {"": "Object;startPos<-,endPos-,syntax-,children-",
  tryMatch$1: function(parser) {
    ...
    if (endMatch != null && endMatch._match.index === 0) {
      this.close$2(this, parser, endMatch);
      return true;
    }
    return false;
  },
  close$2: function(_, parser, endMatch) {
    ...
    t1 = parser._stack;
    t2 = H.Arrays_indexOf(t1, this, 0, t1.length) + 1;
    unmatchedTags = C.JSArray_methods.sublist$1(t1, t2);
    C.JSArray_methods.removeRange$2(t1, t2, t1.length);
    for (t2 = new H.ListIterator(unmatchedTags, unmatchedTags.length, 0, null), t3 = this.children; t2.moveNext$0();) {
      unmatched = t2._current;
    ...
    if (t1.length === 0)
      return t3;
    t1 = this.syntax.onMatchEnd$3(parser, endMatch, this);
    t2 = endMatch._match;
    if (t1) {
      if (0 >= t2.length)
        throw H.ioore(t2, 0);
      t1 = J.get$length$asx(t2[0]);
      t2 = parser.pos;
      if (typeof t1 !== "number")
        throw H.iae(t1);
      parser.pos = t2 + t1;
...
["md_translator", "md_to_html/translator.dart", , A, {
Translator: {"": "Object;conversionDiv-,textarea-,imageManager-,tempConversion-",
  conversion$0: function() {
    var t1, t2, t3, t4, i;
    t1 = this.textarea;
    t2 = J.getInterceptor$x(t1);
    t3 = t2.get$value(t1);
    t4 = this.conversionDiv;
    if (J.get$length$asx(t3) > 0) {
      J.setInnerHtml$1$x(t4, F.markdownToHtml(t3, null, null));
      this.imageManager.imagePosition = 0;
      for (i = 0; t3 = this.imageManager.imagesArray, i < t3.length; ++i)
        J.$indexSet$ax(t3[i], 2, false);
      this.tempConversion = F.markdownToHtml(t2.get$value(t1), null, null);
      this.imageManager.displayImages$0();
    } else
      J.setInnerHtml$1$x(t4, "The HTML view.");
  },
  endOfConversion$0: function() {
    var i, t1, t2, t3;
    this.imageManager.imagePath = null;
    this.imageManager.rightFile = null;
    for (i = 0; t1 = this.imageManager.imagesArray, i < t1.length; ++i)
      if (J.$eq(J.$index$asx(t1[i], 2), false)) {
        t1 = this.imageManager;
        t2 = t1.imagesArray;
        if (i >= t2.length)
          throw H.ioore(t2, i);
        t1.imagesArray = t2.splice$2(t2[i], 1);
      }
    this.tempConversion = J.replaceAll$2$s(this.tempConversion, "<img src=\"img/nofile.png", "<span class=\"nofile-link\"> <span class=\"nofile-visual\">File not found</span>&nbsp;</span><img class=\"nofile\" src=\"img/nofile.png");
    J.setInnerHtml$1$x(this.conversionDiv, this.tempConversion);
    t1 = W._FrozenElementList$_wrap(document.querySelectorAll("#html-conversion a"), null);
    t1.forEach$1(t1, new A.Translator_endOfConversion_closure());
    if (document.querySelector(".nofile") != null) {
      t1 = document.querySelector(".nofile");
      t1.toString;
      t2 = C.EventStreamProvider_click._eventType;
      t1 = new W._ElementEventStreamImpl(t1, t2, false);
      H.setRuntimeTypeInfo(t1, [null]);
      t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Translator_endOfConversion_closure0(this)), t1._useCapture);
      H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t3._tryResume$0();
      t3 = document.querySelector(".nofile-link");
      t3.toString;
      t3 = new W._ElementEventStreamImpl(t3, t2, false);
      H.setRuntimeTypeInfo(t3, [null]);
      t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new A.Translator_endOfConversion_closure1(this)), t3._useCapture);
      H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
      t1._tryResume$0();
      t1 = document.querySelector(".nofile-visual");
      t1.toString;
      t2 = new W._ElementEventStreamImpl(t1, t2, false);
      H.setRuntimeTypeInfo(t2, [null]);
      t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new A.Translator_endOfConversion_closure2(this)), t2._useCapture);
      H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
      t1._tryResume$0();
    }
  },
  Translator$0: function() {
    var t1, t2;
    t1 = new F.ImagesManager(null, [], null, null, null, 0, [], null, ["png", "bmp", "jpeg", "jpg", "gif", "png", "svg", "xbm", "webp"], null, null);
    t1.imgHelp = X.ImagesHelp$(t1);
    t1.translator = this;
    this.imageManager = t1;
    t1 = this.textarea;
    t1.toString;
    t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_input._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Translator_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  static: {
Translator$: function() {
  var t1 = new A.Translator(document.querySelector("#html-conversion"), document.querySelector("#markdown"), null, null);
  t1.Translator$0();
  return t1;
}}
...
Translator_closure: {"": "Closure;this_0-",
  call$1: function(e) {
    this.this_0.conversion$0();
  },
  $is_args1: true
},

Translator_endOfConversion_closure: {"": "Closure;",
  call$1: function(e) {
    e.attr$2("target", "_blank");
  },
  $is_args1: true
},

Translator_endOfConversion_closure0: {"": "Closure;this_0-",
  call$1: function(e) {
  },
  $is_args1: true
},

Translator_endOfConversion_closure1: {"": "Closure;this_1-",
  call$1: function(e) {
  },
  $is_args1: true
},

Translator_endOfConversion_closure2: {"": "Closure;this_2-",
  call$1: function(e) {
  },
  $is_args1: true
}}],
...
init.globalFunctions.clickManagement$closure = V.clickManagement$closure = new P.Closure$1(V.clickManagement, "clickManagement$closure");
init.globalFunctions.shortcutsManagement$closure = V.shortcutsManagement$closure = new P.Closure$1(V.shortcutsManagement, "shortcutsManagement$closure");
...
F.Link.$isObject = true;
F.Node0.$isNode0 = true;
F.Node0.$isObject = true;
F.TagState.$isObject = true;
F.InlineSyntax.$isObject = true;
F.ListItem.$isObject = true;
...
F.InlineParser.$isInlineParser = true;
F.InlineParser.$isObject = true;
...
Isolate.$lazy($, "_RE_HEADER", "_RE_HEADER", "get$_RE_HEADER", function() {
  return new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("^(#{1,6})(.*?)#*$", false, true, false), null, null);
});
Isolate.$lazy($, "_RE_BLOCKQUOTE", "_RE_BLOCKQUOTE", "get$_RE_BLOCKQUOTE", function() {
  return new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("^[ ]{0,3}>[ ]?(.*)$", false, true, false), null, null);
});
...
Isolate.$lazy($, "_RE_HR", "_RE_HR", "get$_RE_HR", function() {
  return new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("^[ ]{0,3}((-+[ ]{0,2}){3,}|(_+[ ]{0,2}){3,}|(\\*+[ ]{0,2}){3,})$", false, true, false), null, null);
});
...
Isolate.$lazy($, "_RE_OL", "_RE_OL", "get$_RE_OL", function() {
  return new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("^[ ]{0,3}\\d+\\.[ \\t]+(.*)$", false, true, false), null, null);
});
Isolate.$lazy($, "_BLOCK_TAGS", "HtmlRenderer__BLOCK_TAGS", "get$HtmlRenderer__BLOCK_TAGS", function() {
  return new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("blockquote|h1|h2|h3|h4|h5|h6|hr|p|pre", false, true, false), null, null);
});
Isolate.$lazy($, "defaultSyntaxes", "InlineParser_defaultSyntaxes", "get$InlineParser_defaultSyntaxes", function() {
  var t1, t2, t3, t4;
  t1 = H.JSSyntaxRegExp_makeNative("\\s*[A-Za-z0-9]+", true, true, false);
  t2 = H.JSSyntaxRegExp_makeNative("<((http|https|ftp)://[^>]*)>", true, true, false);
  t3 = F.LinkSyntax_linkPattern();
  t4 = H.JSSyntaxRegExp_makeNative("\\[", true, true, false);
  t1 = [new F.TextSyntax(null, new H.JSSyntaxRegExp(t1, null, null)), new F.AutolinkSyntax(new H.JSSyntaxRegExp(t2, null, null)), new F.LinkSyntax(null, new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative(t3, true, true, false), null, null), null, new H.JSSyntaxRegExp(t4, null, null)), new F.TextSyntax(null, new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative(" \\* ", true, true, false), null, null)), new F.TextSyntax(null, new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative(" _ ", true, true, false), null, null)), new F.TextSyntax(null, new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("&[#a-zA-Z0-9]*;", true, true, false), null, null)), new F.TextSyntax("&amp;", new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("&", true, true, false), null, null)), new F.TextSyntax("&lt;", new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("<", true, true, false), null, null)), F.TagSyntax$("\\*\\*", null, "strong"), F.TagSyntax$("__", null, "strong"), F.TagSyntax$("\\*", null, "em"), F.TagSyntax$("_", null, "em"), new F.CodeSyntax(new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("``\\s?((?:.|\\n)*?)\\s?``", true, true, false), null, null)), new F.CodeSyntax(new H.JSSyntaxRegExp(H.JSSyntaxRegExp_makeNative("`([^`]*)`", true, true, false), null, null))];
  H.setRuntimeTypeInfo(t1, [F.InlineSyntax]);
  return t1;
});
// Native classes
...
function dart_precompiled($collectedClasses) {
  ...
  function HelpArray(words, answers, examples) {
    this.words = words;
    this.answers = answers;
    this.examples = examples;
  }
  HelpArray.builtin$cls = "HelpArray";
  if (!"name" in HelpArray)
    HelpArray.name = "HelpArray";
  $desc = $collectedClasses.HelpArray;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HelpArray.prototype = $desc;
  function HelpBlock(answer, example, result, resultSwitch) {
    this.answer = answer;
    this.example = example;
    this.result = result;
    this.resultSwitch = resultSwitch;
  }
  HelpBlock.builtin$cls = "HelpBlock";
  if (!"name" in HelpBlock)
    HelpBlock.name = "HelpBlock";
  $desc = $collectedClasses.HelpBlock;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HelpBlock.prototype = $desc;
  function HelpBlock_closure(this_0) {
    this.this_0 = this_0;
  }
  HelpBlock_closure.builtin$cls = "HelpBlock_closure";
  if (!"name" in HelpBlock_closure)
    HelpBlock_closure.name = "HelpBlock_closure";
  $desc = $collectedClasses.HelpBlock_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HelpBlock_closure.prototype = $desc;
  function HelpManager(helpButton, helpDisplayer, helpInput, resultsContainer, helpBlock, maxAnswers, wordPos, helpArray) {
  ...
  HelpManager.builtin$cls = "HelpManager";
  if (!"name" in HelpManager)
    HelpManager.name = "HelpManager";
  $desc = $collectedClasses.HelpManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HelpManager.prototype = $desc;
  function HelpManager_closure(this_0) {
    this.this_0 = this_0;
  }
  HelpManager_closure.builtin$cls = "HelpManager_closure";
  if (!"name" in HelpManager_closure)
    HelpManager_closure.name = "HelpManager_closure";
  $desc = $collectedClasses.HelpManager_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HelpManager_closure.prototype = $desc;
  function ImagesHelp(altInput, galleriesButton, imageButton, imageBox, imageBrowser, imageDisplayer, imageStatus, titleInput, imgManager) {
    this.altInput = altInput;
    this.galleriesButton = galleriesButton;
  ...
  ImagesHelp.builtin$cls = "ImagesHelp";
  if (!"name" in ImagesHelp)
    ImagesHelp.name = "ImagesHelp";
  $desc = $collectedClasses.ImagesHelp;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ImagesHelp.prototype = $desc;
  function ImagesHelp_closure(this_0) {
    this.this_0 = this_0;
  }
  ImagesHelp_closure.builtin$cls = "ImagesHelp_closure";
  if (!"name" in ImagesHelp_closure)
    ImagesHelp_closure.name = "ImagesHelp_closure";
  $desc = $collectedClasses.ImagesHelp_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ImagesHelp_closure.prototype = $desc;
  function ImagesManager(currentGallery, galleriesList, image, imageLoaded, imagePath, imagePosition, imagesArray, imgHelp, imgFormats, rightFile, translator) {
  ...
  ImagesManager.builtin$cls = "ImagesManager";
  if (!"name" in ImagesManager)
    ImagesManager.name = "ImagesManager";
  $desc = $collectedClasses.ImagesManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ImagesManager.prototype = $desc;
  function Document(refLinks, inlineSyntaxes, linkResolver) {
  ...
  function BlockParser(lines, document, pos) {
    this.lines = lines;
  ...
  $desc = $collectedClasses.BlockParser;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.BlockSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BlockSyntax.prototype = $desc;
  function BlockSyntax_isAtBlockEnd_closure(parser_0) {
  ...
  $desc = $collectedClasses.BlockSyntax_isAtBlockEnd_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.EmptyBlockSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.SetextHeaderSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.HeaderSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.BlockquoteSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.CodeBlockSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CodeBlockSyntax.prototype = $desc;
  function GitHubCodeBlockSyntax() {
  }
  GitHubCodeBlockSyntax.builtin$cls = "GitHubCodeBlockSyntax";
  if (!"name" in GitHubCodeBlockSyntax)
    GitHubCodeBlockSyntax.name = "GitHubCodeBlockSyntax";
  $desc = $collectedClasses.GitHubCodeBlockSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GitHubCodeBlockSyntax.prototype = $desc;
  ...
  $desc = $collectedClasses.HorizontalRuleSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.BlockHtmlSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  ListItem.prototype.get$forceBlock = function() {
  ...
  $desc = $collectedClasses.ListSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ListSyntax.prototype = $desc;
  function ListSyntax_parse_endItem(box_0, items_1) {
    this.box_0 = box_0;
  ...
  $desc = $collectedClasses.ListSyntax_parse_endItem;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ListSyntax_parse_endItem.prototype = $desc;
  function ListSyntax_parse_tryMatch(box_0, parser_2) {
    this.box_0 = box_0;
  ...
  $desc = $collectedClasses.ListSyntax_parse_tryMatch;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.UnorderedListSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.OrderedListSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.ParagraphSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.HtmlRenderer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.HtmlRenderer_visitElementBefore_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.InlineParser;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.InlineSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.TextSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.AutolinkSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.TagSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.LinkSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.CodeSyntax;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.TagState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function Translator(conversionDiv, textarea, imageManager, tempConversion) {
    this.conversionDiv = conversionDiv;
  ...
  function Translator_closure(this_0) {
    this.this_0 = this_0;
  }
  ...
  function Translator_endOfConversion_closure() {
  }
  Translator_endOfConversion_closure.builtin$cls = "Translator_endOfConversion_closure";
  if (!"name" in Translator_endOfConversion_closure)
    Translator_endOfConversion_closure.name = "Translator_endOfConversion_closure";
  $desc = $collectedClasses.Translator_endOfConversion_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Translator_endOfConversion_closure.prototype = $desc;
  function Translator_endOfConversion_closure0(this_0) {
    this.this_0 = this_0;
  }
  Translator_endOfConversion_closure0.builtin$cls = "Translator_endOfConversion_closure0";
  if (!"name" in Translator_endOfConversion_closure0)
    Translator_endOfConversion_closure0.name = "Translator_endOfConversion_closure0";
  $desc = $collectedClasses.Translator_endOfConversion_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Translator_endOfConversion_closure0.prototype = $desc;
  function Translator_endOfConversion_closure1(this_1) {
    this.this_1 = this_1;
  }
  Translator_endOfConversion_closure1.builtin$cls = "Translator_endOfConversion_closure1";
  if (!"name" in Translator_endOfConversion_closure1)
    Translator_endOfConversion_closure1.name = "Translator_endOfConversion_closure1";
  $desc = $collectedClasses.Translator_endOfConversion_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Translator_endOfConversion_closure1.prototype = $desc;
  function Translator_endOfConversion_closure2(this_2) {
    this.this_2 = this_2;
  }
  Translator_endOfConversion_closure2.builtin$cls = "Translator_endOfConversion_closure2";
  if (!"name" in Translator_endOfConversion_closure2)
    Translator_endOfConversion_closure2.name = "Translator_endOfConversion_closure2";
  $desc = $collectedClasses.Translator_endOfConversion_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Translator_endOfConversion_closure2.prototype = $desc;

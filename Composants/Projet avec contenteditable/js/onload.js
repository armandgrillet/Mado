...
window.onload = function() {
    ...
    */
    ...
    $(exportButton).on("click", function() { exportFile(); });
    ...
    Mousetrap.bind(['command+left', 'ctrl+left'], function(e) { switchShortcuts("left"); return false; }); // Ctrl+k = link.
    Mousetrap.bind(['command+right', 'ctrl+right'], function(e) { switchShortcuts("right"); return false; }); // Ctrl+k = link.
}